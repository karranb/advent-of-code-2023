input = """.......358..........31.....339.....669.............598......328.....575......................447..650..............964...........692........
...
def part_1():
    ...
    def check_is_valid(indexes):
        for [index_i, index_j] in indexes:
            adjacent_search_index = [
                [0, 1],
                [1, 0],
                [1 , 1],
                [0, -1],
            ...
            for [add_i, add_j] in adjacent_search_index:
                adjacent_i = index_i + add_i
                adjacent_j = index_j + add_j
                try:
                    if not re.match('\d|\.', lines[adjacent_i][adjacent_j]):
                        return True
                except IndexError:
                    pass
        return False
    ...
    for i, line in enumerate(lines):
        ...
        for j, char in enumerate(line):
            if char.isdigit():
                ...
                if check_is_valid(indexes):
                    total += int(current_number)
                current_number = ''
                indexes = []
            if len(line) == j+1 and check_is_valid(indexes):
                total += int(current_number)
    return total

def part_2():
    
    def get_number_and_index(i, j):
        number = lines[i][j]
        index = (i, j)
        current_j = j
        while True:
            try:
                current_j -= 1
                if lines[i][current_j].isdigit():
                    number = lines[i][current_j] + number
                    index = (i, current_j)
                else:
                    break
            except IndexError:
    ...
    def find_asterisk_value(i, j):
        adjacent_numbers_index = {}
        ...
        for [add_i, add_j] in adjacent_search_index:
            ...
            adjacent_j = j + add_j
            try:
                if lines[adjacent_i][adjacent_j].isdigit():
                    number, index = get_number_and_index(adjacent_i, adjacent_j)
                    adjacent_numbers_index[index] = number
            except IndexError:
                pass
        adjacent_numbers = list(adjacent_numbers_index.values())
